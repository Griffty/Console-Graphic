...
public class Settings extends JFrame {
    ...
    public static Main.allShapes shape = Main.allShapes.Torus;
    ...
    private void initGui(){
        ...
        setUpPanel(PanelsNames.Shape, "Shape:", new String[]{"Rectangle", "Circle", "Annulus", "Sphere", "Torus"},1);
        // Bottom Panel
        ...
        saveAndStartButton.addActionListener(e -> {
            saveData();
            try {
                Process p = Runtime.getRuntime().exec("cmd /c start wt java Main / max");
                p.waitFor();
    ...
    private static void moveData(){
        ...
        Transformation.consoleWidth = Width;
        Transformation.consoleHeight = Height;
        Transformation.consoleLength = Length;
        Shapes.consoleWidth = Width;
        Shapes.consoleHeight = Height;
        Shapes.consoleLength = Length;

        Transformation.current_x = Start_x;
        Transformation.current_y = Start_y;
        Transformation.current_z = Start_z;
        Transformation.currentRotation_x = Rotation_x;
        Transformation.currentRotation_y = Rotation_y;
        Transformation.currentRotation_z = Rotation_z;

        Shapes.R = R;

        Main.symbolRatio = ratio;
        Shapes.ratio = ratio;
